...
- Next-round brief: [briefs/next-brain-co.md](../briefs/next-brain-co.md)
- Decision journal: [decision-journal.md](./decision-journal.md)
- Pipeline: [../pipeline.md](../pipeline.md)
- Story gap: incomplete-info STAR is drafted in [_shared/story-bank.md](../_shared/story-bank.md). Rehearse before the hiring manager. Tighten numbers if useful.
