# Invisible Technologies: Interview Notes and Prep
...
- Panel call scheduled: Tuesday, August 11, 2026, 12:30 PM ET
...
- August 10: Lapo confirmed availability for panel call with Nancy Vo, Derek Pages, and Hiring-Scheduling

## Current status

Interview loop continues. Panel call scheduled for Tuesday, August 11, 2026, 12:30 PM ET. Lapo has extended deadline (until next Thursday) and has flagged Invisible as top choice to Derek. Awaiting panel conversation.
...
- Format: Panel call
- When: Tuesday, August 11, 2026, 12:30 PM ET
- With: Panel members TBD (likely includes Kate Alvarico, Hafsa Tahir, or other stakeholders)
- Stage: Post-final-round, likely decision or deep-dive panel

### Prep approach

- Ranjani conversation landed well. Assume panel will dig into substance from that call or test new angles (execution, team dynamics, trade-offs under constraints)
- Invisible's domain and product focus still not confirmed in writing. Listen for what they emphasize in opening remarks; do not assume
- Bring specifics from Kinage (multi-account deployment, cost-to-serve reduction, coaching deployed engineers) and regulated-environment judgment (eval gates, production quality, field failure modes into product)
- Be ready to speak to incomplete-info shipping and scope cuts if they ask about speed or pragmatism
- Tone: calm, specific, readable. No overclaim on formal management headcount; lead by ownership and coaching
- If they ask about gov or MENA depth, say it may be thin
- Have a short question ready about what success looks like in the first 90 days, or what the biggest blocker is right now

### Before the call

- Confirm panel member names and roles if possible (ask Derek or Kate on Monday if they send a prep note)
- Review any notes from Ranjani conversation for themes to carry forward
- Have Kinage playbook and cost-to-serve story ready in short form
- Confirm dial-in details and test audio/video 10 minutes early
