...
const jobs = [
  {
    ...
    bullets: [
      "Operate as a broader partner to the CEO beyond the product mandate: pipeline, CRM, client conversations, weekly operating cadence, financial planning, investor reporting, unit economics, and company-level priorities.",
      ...
      "Built an internal GTM Intelligence Platform (HAL) monitoring 57 market feeds: ranks relevant market signals, extracts named prospects, surfaces outreach opportunities, and gives leadership a live view of GTM activity and blockers.",
      ...
      "Built enrichment architecture for a ~1,200-contact advisor segment: market scoring, geographic segmentation, company enrichment, social activity signals, and controlled CRM writeback.",
    ],
